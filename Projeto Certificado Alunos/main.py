...
for indice, linha in enumerate(sheet_alunos.iter_rows(min_row=2,)):
    nome_curso = linha[0].value # pegando o valor da primeira coluna (nome do curso)
    nome_participante = linha[1].value # pegando o nome do participante
...
# Transferir os dados para a imagem do certificado
# Escolhendo a fonte a ser usada
    ...
    desenhar.text((2200,1930),data_emissao,fill="black",font=fonte_data)
